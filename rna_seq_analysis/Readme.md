...
<img width="948" alt="image" src="https://github.com/HuangShiLab/zhangyf/assets/170502144/e62d733d-0a23-4e73-afff-ddc31fa48bbb">
...
* Input data: Raw data (fastq.gz file)  
* Commands:  
```
...
* Input data: clean data (fastq.gz)  
* Commands:  
```
...
* Input data: sam file generated by bowtie2  
* Commands:  
```
